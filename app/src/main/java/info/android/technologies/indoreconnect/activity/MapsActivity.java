...
public class MapsActivity extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent in = getIntent();
        fromLatitude = in.getDoubleExtra("fromlat", 0);
        fromLongitude = in.getDoubleExtra("fromlong", 0);
        toLatitude = in.getDoubleExtra("tolat", 0);
        toLongitude = in.getDoubleExtra("tolong", 0);
        ...
        back_iv = (ImageView) findViewById(R.id.iv_map_back);
...
/*
    ...
    public String makeURL(double sourcelat, double sourcelog, double destlat, double destlog) {
        ...
        urlString.append("&key=AIzaSyDyBbrgAFoMXK8lDvMtC7hZhe6WnCnw-jQ");
    ...
    public void drawPath(String result) {
        ...
        Toast.makeText(this, String.valueOf(distance_km + " Meters"), Toast.LENGTH_SHORT).show();

 ...
 */
public class Adp_ShopListing extends RecyclerView.Adapter<Adp_ShopListing.MyViewHolder> {

    private List<BuisnessList> buisnessLists;
    Context ctx;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view, int i, Context ctx) {
            ...
            if (i == 1) {
                title_tv = (TextView) view.findViewById(info.android.technologies.indoreconnect.R.id.tv_adpshop_title);
                address_tv = (TextView) view.findViewById(info.android.technologies.indoreconnect.R.id.tv_adpshop_address);
                contact_tv = (TextView) view.findViewById(info.android.technologies.indoreconnect.R.id.tv_adpshop_contact);
                distance_tv = (TextView) view.findViewById(info.android.technologies.indoreconnect.R.id.tv_adpshop_distance);
                more_tv = (TextView) view.findViewById(info.android.technologies.indoreconnect.R.id.tv_adpshop_more);
                ratingBar = (RatingBar) view.findViewById(info.android.technologies.indoreconnect.R.id.rb_adpshop_rating);
                imageView = (ImageView) view.findViewById(info.android.technologies.indoreconnect.R.id.iv_adpshop_image);
            } else {
                ViewPager viewPager = (ViewPager) view.findViewById(info.android.technologies.indoreconnect.R.id.vp_shoplist_viewpager);
                title_tv = (TextView) view.findViewById(info.android.technologies.indoreconnect.R.id.tv_shoplist_title);
                address_tv = (TextView) view.findViewById(info.android.technologies.indoreconnect.R.id.tv_shoplist_address);
                contact_tv = (TextView) view.findViewById(info.android.technologies.indoreconnect.R.id.tv_shoplist_contact);
                distance_tv = (TextView) view.findViewById(info.android.technologies.indoreconnect.R.id.tv_shoplist_distance);
                more_tv = (TextView) view.findViewById(info.android.technologies.indoreconnect.R.id.tv_shoplist_more);
                ratingBar = (RatingBar) view.findViewById(info.android.technologies.indoreconnect.R.id.rb_shoplist_rating);
                imageView = (ImageView) view.findViewById(info.android.technologies.indoreconnect.R.id.iv_shoplist_image);
...
//                String response = "{\"result\":[{\"image\":\"http://encodletechnologies.com/kingfaisal/wokshop-dashboard/images/title.jpg\"},{\"image\":\"http://encodletechnologies.com/kingfaisal/wokshop-dashboard/images/images.jpg\"},{\"image\":\"http://encodletechnologies.com/kingfaisal/wokshop-dashboard/images/download.png\"},{\"image\":\"http://encodletechnologies.com/kingfaisal/wokshop-dashboard/images/logo.png\"}]}";
    ...
    public Adp_ShopListing(List<BuisnessList> moviesList, Context ctx, double latitude, double longitude) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) {
            ...
            itemView = LayoutInflater.from(parent.getContext())
                    .inflate(info.android.technologies.indoreconnect.R.layout.advertisment_shoplist_slider, parent, false);
            return new MyViewHolder(itemView, 0, parent.getContext());
        } else {
            itemView = LayoutInflater.from(parent.getContext())
                    .inflate(info.android.technologies.indoreconnect.R.layout.adp_shoplistview, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        BuisnessList buisness = buisnessLists.get(position);
        ...
        String rating = buisnessLists.get(position).getRating();
        ...
        double buiss_lat = Double.parseDouble(buisnessLists.get(position).getLat());
        double buiss_long = Double.parseDouble(buisnessLists.get(position).getSet_long());

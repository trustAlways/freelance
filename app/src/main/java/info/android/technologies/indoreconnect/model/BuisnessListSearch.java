 ...
 */
public class BuisnessListSearch {
    ...
    private double lat;
    private double set_long;
    private String image;
    private int rating;
    private double distance;
    private String cate_icon;

    public BuisnessListSearch(String buisness_id, String status, String buisness_name, String building, String street,
                              String estb_year, String area, String city, String pincode, String state, String contact_person_title,
                              String contact_person_name, String designation, String landline_no1, String landline_no2, String mobile_no1,
                              String mobile_no2, String email_id, String website, double lat, double set_long, String image,
                              int rating, double distance, String cate_icon) {
    ...
    public double getSet_long() {
        return set_long;
    }

    public void setSet_long(double set_long) {
        this.set_long = set_long;
    }
